...
async def sample_delete_evaluation_job():
    ...
    # Make the request
    response = await client.delete_evaluation_job(request=request)


# [END datalabeling_generated_datalabeling_v1beta1_DataLabelingService_DeleteEvaluationJob_async]
