...
async def sample_resume_evaluation_job():
    ...
    # Make the request
    response = await client.resume_evaluation_job(request=request)


# [END datalabeling_generated_datalabeling_v1beta1_DataLabelingService_ResumeEvaluationJob_async]
