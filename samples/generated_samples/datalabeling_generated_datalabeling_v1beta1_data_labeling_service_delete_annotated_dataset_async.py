...
#
# Snippet for DeleteAnnotatedDataset
...
async def sample_delete_annotated_dataset():
    ...
    # Make the request
    response = await client.delete_annotated_dataset(request=request)


# [END datalabeling_generated_datalabeling_v1beta1_DataLabelingService_DeleteAnnotatedDataset_async]
