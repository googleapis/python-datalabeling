...
BigQuerySource = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      input_uri:
          ...
          schema </ml-engine/docs/continuous-evaluation/create-job
          #table-schema>`__.  Provide the table URI in the following
          format:
          “bq://{your_project_id}/{your_dataset_name}/{your_table_name}”
          `Learn more </ml-engine/docs/continuous-evaluation/create-job
          #table-schema>`__.
  """,
