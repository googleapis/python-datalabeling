...
BoundingBoxEvaluationOptions = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      iou_threshold:
          Minimum [intersection-over-union  (IOU)](/vision/automl
          /object-detection/docs/evaluate#intersection-over-union)
...
PrCurve = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        confidence_threshold:
            ...
            (IOU)](/vision/automl/object-detection/docs/evaluate
            #intersection-over-union) threshold for the context of this
