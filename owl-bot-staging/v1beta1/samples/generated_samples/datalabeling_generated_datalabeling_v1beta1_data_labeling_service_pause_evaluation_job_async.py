...
async def sample_pause_evaluation_job():
    ...
    # Make the request
    response = await client.pause_evaluation_job(request=request)


# [END datalabeling_generated_datalabeling_v1beta1_DataLabelingService_PauseEvaluationJob_async]
