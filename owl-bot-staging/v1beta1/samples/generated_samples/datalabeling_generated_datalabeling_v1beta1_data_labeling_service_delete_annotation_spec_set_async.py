...
#
# Snippet for DeleteAnnotationSpecSet
...
async def sample_delete_annotation_spec_set():
    ...
    # Make the request
    response = await client.delete_annotation_spec_set(request=request)


# [END datalabeling_generated_datalabeling_v1beta1_DataLabelingService_DeleteAnnotationSpecSet_async]
