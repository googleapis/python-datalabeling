...
class DataLabelingServiceClient(metaclass=DataLabelingServiceClientMeta):
    ...
    def create_annotation_spec_set(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_annotation_spec_set]
    ...
    def list_annotation_spec_sets(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_annotation_spec_sets]
    ...
    def delete_annotation_spec_set(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_annotation_spec_set]
    ...
    def search_example_comparisons(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_example_comparisons]
