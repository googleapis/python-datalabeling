...
class ExportDataOperationResponse(proto.Message):
    ...
    label_stats = proto.Field(proto.MESSAGE, number=4,
...
class LabelOperationMetadata(proto.Message):
    ...
    image_classification_details = proto.Field(proto.MESSAGE, number=3, oneof='details',
        message='LabelImageClassificationOperationMetadata',
    )

    image_bounding_box_details = proto.Field(proto.MESSAGE, number=4, oneof='details',
        message='LabelImageBoundingBoxOperationMetadata',
    )

    image_bounding_poly_details = proto.Field(proto.MESSAGE, number=11, oneof='details',
        message='LabelImageBoundingPolyOperationMetadata',
    )

    image_oriented_bounding_box_details = proto.Field(proto.MESSAGE, number=14, oneof='details',
        message='LabelImageOrientedBoundingBoxOperationMetadata',
    )

    image_polyline_details = proto.Field(proto.MESSAGE, number=12, oneof='details',
        message='LabelImagePolylineOperationMetadata',
    )

    image_segmentation_details = proto.Field(proto.MESSAGE, number=15, oneof='details',
        message='LabelImageSegmentationOperationMetadata',
    )

    video_classification_details = proto.Field(proto.MESSAGE, number=5, oneof='details',
        message='LabelVideoClassificationOperationMetadata',
    )

    video_object_detection_details = proto.Field(proto.MESSAGE, number=6, oneof='details',
        message='LabelVideoObjectDetectionOperationMetadata',
    )

    video_object_tracking_details = proto.Field(proto.MESSAGE, number=7, oneof='details',
        message='LabelVideoObjectTrackingOperationMetadata',
    )

    video_event_details = proto.Field(proto.MESSAGE, number=8, oneof='details',
        message='LabelVideoEventOperationMetadata',
    )

    text_classification_details = proto.Field(proto.MESSAGE, number=9, oneof='details',
        message='LabelTextClassificationOperationMetadata',
    )

    text_entity_extraction_details = proto.Field(proto.MESSAGE, number=13, oneof='details',
...
class LabelImageClassificationOperationMetadata(proto.Message):
    ...
    basic_config = proto.Field(proto.MESSAGE, number=1,
