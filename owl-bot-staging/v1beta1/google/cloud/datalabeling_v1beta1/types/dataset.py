...
class Dataset(proto.Message):
    ...
    input_configs = proto.RepeatedField(proto.MESSAGE, number=5,
        message='InputConfig',
    )
...
class InputConfig(proto.Message):
    ...
    text_metadata = proto.Field(proto.MESSAGE, number=6, oneof='data_type_metadata',
    ...
    bigquery_source = proto.Field(proto.MESSAGE, number=5, oneof='source',
        message='BigQuerySource',
    )

    data_type = proto.Field(proto.ENUM, number=1,
        enum='DataType',
    )

    annotation_type = proto.Field(proto.ENUM, number=3,
        enum=annotation.AnnotationType,
    )

    classification_metadata = proto.Field(proto.MESSAGE, number=4,
...
class OutputConfig(proto.Message):
    ...
    gcs_folder_destination = proto.Field(proto.MESSAGE, number=2, oneof='destination',
...
class DataItem(proto.Message):
    ...
    image_payload = proto.Field(proto.MESSAGE, number=2, oneof='payload',
        message=data_payloads.ImagePayload,
    )

    text_payload = proto.Field(proto.MESSAGE, number=3, oneof='payload',
        message=data_payloads.TextPayload,
    )

    video_payload = proto.Field(proto.MESSAGE, number=4, oneof='payload',
...
class AnnotatedDataset(proto.Message):
    ...
    annotation_source = proto.Field(proto.ENUM, number=3,
        enum=annotation.AnnotationSource,
    )

    annotation_type = proto.Field(proto.ENUM, number=8,
        enum=annotation.AnnotationType,
    )
    ...
    label_stats = proto.Field(proto.MESSAGE, number=6,
        message='LabelStats',
    )
    ...
    metadata = proto.Field(proto.MESSAGE, number=10,
...
class AnnotatedDatasetMetadata(proto.Message):
    ...
    image_classification_config = proto.Field(proto.MESSAGE, number=2, oneof='annotation_request_config',
        message=gcd_human_annotation_config.ImageClassificationConfig,
    )

    bounding_poly_config = proto.Field(proto.MESSAGE, number=3, oneof='annotation_request_config',
        message=gcd_human_annotation_config.BoundingPolyConfig,
    )

    polyline_config = proto.Field(proto.MESSAGE, number=4, oneof='annotation_request_config',
        message=gcd_human_annotation_config.PolylineConfig,
    )

    segmentation_config = proto.Field(proto.MESSAGE, number=5, oneof='annotation_request_config',
        message=gcd_human_annotation_config.SegmentationConfig,
    )

    video_classification_config = proto.Field(proto.MESSAGE, number=6, oneof='annotation_request_config',
        message=gcd_human_annotation_config.VideoClassificationConfig,
    )

    object_detection_config = proto.Field(proto.MESSAGE, number=7, oneof='annotation_request_config',
        message=gcd_human_annotation_config.ObjectDetectionConfig,
    )

    object_tracking_config = proto.Field(proto.MESSAGE, number=8, oneof='annotation_request_config',
        message=gcd_human_annotation_config.ObjectTrackingConfig,
    )

    event_config = proto.Field(proto.MESSAGE, number=9, oneof='annotation_request_config',
        message=gcd_human_annotation_config.EventConfig,
    )

    text_classification_config = proto.Field(proto.MESSAGE, number=10, oneof='annotation_request_config',
        message=gcd_human_annotation_config.TextClassificationConfig,
    )

    text_entity_extraction_config = proto.Field(proto.MESSAGE, number=11, oneof='annotation_request_config',
        message=gcd_human_annotation_config.TextEntityExtractionConfig,
    )

    human_annotation_config = proto.Field(proto.MESSAGE, number=1,
...
class Example(proto.Message):
    ...
    text_payload = proto.Field(proto.MESSAGE, number=6, oneof='payload',
        message=data_payloads.TextPayload,
    )

    video_payload = proto.Field(proto.MESSAGE, number=7, oneof='payload',
        message=data_payloads.VideoPayload,
    )

    name = proto.Field(proto.STRING, number=1)

    annotations = proto.RepeatedField(proto.MESSAGE, number=5,
