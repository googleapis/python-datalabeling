...
class Evaluation(proto.Message):
    ...
    evaluation_job_run_time = proto.Field(proto.MESSAGE, number=3,
    ...
    evaluation_metrics = proto.Field(proto.MESSAGE, number=5,
        message='EvaluationMetrics',
    )

    annotation_type = proto.Field(proto.ENUM, number=6,
...
class EvaluationConfig(proto.Message):
    ...
    bounding_box_evaluation_options = proto.Field(proto.MESSAGE, number=1, oneof='vertical_option',
...
class EvaluationMetrics(proto.Message):
    ...
    classification_metrics = proto.Field(proto.MESSAGE, number=1, oneof='metrics',
        message='ClassificationMetrics',
    )

    object_detection_metrics = proto.Field(proto.MESSAGE, number=2, oneof='metrics',
...
class ClassificationMetrics(proto.Message):
    ...
    pr_curve = proto.Field(proto.MESSAGE, number=1,
        message='PrCurve',
    )

    confusion_matrix = proto.Field(proto.MESSAGE, number=2,
...
class ConfusionMatrix(proto.Message):
    ...
    row = proto.RepeatedField(proto.MESSAGE, number=1,
        message=Row,
    )
