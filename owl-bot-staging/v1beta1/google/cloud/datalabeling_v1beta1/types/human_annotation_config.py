...
class HumanAnnotationConfig(proto.Message):
    ...
    question_duration = proto.Field(proto.MESSAGE, number=7,
...
class ImageClassificationConfig(proto.Message):
    ...
    answer_aggregation_type = proto.Field(proto.ENUM, number=3,
...
class VideoClassificationConfig(proto.Message):
    ...
    annotation_spec_set_configs = proto.RepeatedField(proto.MESSAGE, number=1,
...
class TextClassificationConfig(proto.Message):
    ...
    sentiment_config = proto.Field(proto.MESSAGE, number=3,
