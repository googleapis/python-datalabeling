...
from google.cloud.datalabeling_v1beta1.services.data_labeling_service import DataLabelingServiceAsyncClient
from google.cloud.datalabeling_v1beta1.services.data_labeling_service import DataLabelingServiceClient
...
from google.cloud.datalabeling_v1beta1.services.data_labeling_service.transports.base import _API_CORE_VERSION
from google.cloud.datalabeling_v1beta1.services.data_labeling_service.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (DataLabelingServiceClient, transports.DataLabelingServiceGrpcTransport, "grpc"),
    (DataLabelingServiceAsyncClient, transports.DataLabelingServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (DataLabelingServiceClient, transports.DataLabelingServiceGrpcTransport, "grpc", "true"),
    (DataLabelingServiceAsyncClient, transports.DataLabelingServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (DataLabelingServiceClient, transports.DataLabelingServiceGrpcTransport, "grpc", "false"),
    (DataLabelingServiceAsyncClient, transports.DataLabelingServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(DataLabelingServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataLabelingServiceClient))
@mock.patch.object(DataLabelingServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataLabelingServiceAsyncClient))
...
def test_data_labeling_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_create_dataset(transport: str = 'grpc', request_type=data_labeling_service.CreateDatasetRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_dataset_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.CreateDatasetRequest):
...
def test_get_dataset(transport: str = 'grpc', request_type=data_labeling_service.GetDatasetRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_dataset_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.GetDatasetRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_datasets(transport: str = 'grpc', request_type=data_labeling_service.ListDatasetsRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_datasets_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ListDatasetsRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListDatasetsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_delete_dataset(transport: str = 'grpc', request_type=data_labeling_service.DeleteDatasetRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_dataset_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.DeleteDatasetRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_data(transport: str = 'grpc', request_type=data_labeling_service.ImportDataRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_import_data_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ImportDataRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_data_flattened():
    ...
    with mock.patch.object(
        ...
        client.import_data(
            name='name_value',
            input_config=dataset.InputConfig(text_metadata=dataset.TextMetadata(language_code='language_code_value')),
        )
...
def test_export_data(transport: str = 'grpc', request_type=data_labeling_service.ExportDataRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_export_data_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ExportDataRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_data_flattened():
    ...
    with mock.patch.object(
        ...
        client.export_data(
            ...
            filter='filter_value',
            output_config=dataset.OutputConfig(gcs_destination=dataset.GcsDestination(output_uri='output_uri_value')),
        )
...
def test_get_data_item(transport: str = 'grpc', request_type=data_labeling_service.GetDataItemRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_item),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_data_item_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.GetDataItemRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_data_items(transport: str = 'grpc', request_type=data_labeling_service.ListDataItemsRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_data_items),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_data_items_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ListDataItemsRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_data_items_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, dataset.DataItem)
                   for i in results)
...
def test_get_annotated_dataset(transport: str = 'grpc', request_type=data_labeling_service.GetAnnotatedDatasetRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_annotated_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_annotated_dataset_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.GetAnnotatedDatasetRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataset.AnnotatedDataset(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            annotation_source=annotation.AnnotationSource.OPERATOR,
...
def test_list_annotated_datasets(transport: str = 'grpc', request_type=data_labeling_service.ListAnnotatedDatasetsRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_annotated_datasets_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ListAnnotatedDatasetsRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListAnnotatedDatasetsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_annotated_datasets_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, dataset.AnnotatedDataset)
                   for i in results)
...
def test_delete_annotated_dataset(transport: str = 'grpc', request_type=data_labeling_service.DeleteAnnotatedDatasetRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_annotated_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_annotated_dataset_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.DeleteAnnotatedDatasetRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_label_image(transport: str = 'grpc', request_type=data_labeling_service.LabelImageRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.label_image),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_label_image_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.LabelImageRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_label_image_flattened():
    ...
    with mock.patch.object(
        ...
        client.label_image(
            parent='parent_value',
            basic_config=human_annotation_config.HumanAnnotationConfig(instruction='instruction_value'),
...
def test_label_video(transport: str = 'grpc', request_type=data_labeling_service.LabelVideoRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.label_video),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_label_video_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.LabelVideoRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_label_text(transport: str = 'grpc', request_type=data_labeling_service.LabelTextRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.label_text),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_label_text_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.LabelTextRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_example(transport: str = 'grpc', request_type=data_labeling_service.GetExampleRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_example),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_example_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.GetExampleRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_examples(transport: str = 'grpc', request_type=data_labeling_service.ListExamplesRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_examples),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_examples_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ListExamplesRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListExamplesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_examples_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, dataset.Example)
                   for i in results)
...
def test_create_annotation_spec_set(transport: str = 'grpc', request_type=data_labeling_service.CreateAnnotationSpecSetRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_annotation_spec_set),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_annotation_spec_set_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.CreateAnnotationSpecSetRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gcd_annotation_spec_set.AnnotationSpecSet(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            blocking_resources=['blocking_resources_value'],
...
def test_create_annotation_spec_set_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_annotation_spec_set(
            parent='parent_value',
            annotation_spec_set=gcd_annotation_spec_set.AnnotationSpecSet(name='name_value'),
        )
...
def test_get_annotation_spec_set(transport: str = 'grpc', request_type=data_labeling_service.GetAnnotationSpecSetRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_annotation_spec_set),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_annotation_spec_set_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.GetAnnotationSpecSetRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(annotation_spec_set.AnnotationSpecSet(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            blocking_resources=['blocking_resources_value'],
...
def test_list_annotation_spec_sets(transport: str = 'grpc', request_type=data_labeling_service.ListAnnotationSpecSetsRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_annotation_spec_sets_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ListAnnotationSpecSetsRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListAnnotationSpecSetsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_annotation_spec_sets_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, annotation_spec_set.AnnotationSpecSet)
                   for i in results)
...
def test_delete_annotation_spec_set(transport: str = 'grpc', request_type=data_labeling_service.DeleteAnnotationSpecSetRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_annotation_spec_set),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_annotation_spec_set_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.DeleteAnnotationSpecSetRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_instruction(transport: str = 'grpc', request_type=data_labeling_service.CreateInstructionRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_instruction),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_instruction_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.CreateInstructionRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instruction(transport: str = 'grpc', request_type=data_labeling_service.GetInstructionRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_instruction),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_instruction_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.GetInstructionRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(instruction.Instruction(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            data_type=dataset.DataType.IMAGE,
...
def test_list_instructions(transport: str = 'grpc', request_type=data_labeling_service.ListInstructionsRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_instructions_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ListInstructionsRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListInstructionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_instructions_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, instruction.Instruction)
                   for i in results)
...
def test_delete_instruction(transport: str = 'grpc', request_type=data_labeling_service.DeleteInstructionRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_instruction),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_instruction_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.DeleteInstructionRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_evaluation(transport: str = 'grpc', request_type=data_labeling_service.GetEvaluationRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_evaluation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_evaluation_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.GetEvaluationRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_evaluations(transport: str = 'grpc', request_type=data_labeling_service.SearchEvaluationsRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_search_evaluations_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.SearchEvaluationsRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_evaluations_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, evaluation.Evaluation)
                   for i in results)
...
def test_search_example_comparisons(transport: str = 'grpc', request_type=data_labeling_service.SearchExampleComparisonsRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_search_example_comparisons_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.SearchExampleComparisonsRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.SearchExampleComparisonsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_search_example_comparisons_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, data_labeling_service.SearchExampleComparisonsResponse.ExampleComparison)
                   for i in results)
...
def test_create_evaluation_job(transport: str = 'grpc', request_type=data_labeling_service.CreateEvaluationJobRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_evaluation_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_evaluation_job_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.CreateEvaluationJobRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(evaluation_job.EvaluationJob(
            name='name_value',
            description='description_value',
            state=evaluation_job.EvaluationJob.State.SCHEDULED,
            schedule='schedule_value',
...
def test_update_evaluation_job(transport: str = 'grpc', request_type=data_labeling_service.UpdateEvaluationJobRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_evaluation_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_update_evaluation_job_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.UpdateEvaluationJobRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gcd_evaluation_job.EvaluationJob(
            name='name_value',
            description='description_value',
            state=gcd_evaluation_job.EvaluationJob.State.SCHEDULED,
            schedule='schedule_value',
...
def test_get_evaluation_job(transport: str = 'grpc', request_type=data_labeling_service.GetEvaluationJobRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_evaluation_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = evaluation_job.EvaluationJob(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_evaluation_job_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.GetEvaluationJobRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pause_evaluation_job(transport: str = 'grpc', request_type=data_labeling_service.PauseEvaluationJobRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.pause_evaluation_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_pause_evaluation_job_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.PauseEvaluationJobRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_evaluation_job(transport: str = 'grpc', request_type=data_labeling_service.ResumeEvaluationJobRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_evaluation_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_resume_evaluation_job_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ResumeEvaluationJobRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_evaluation_job(transport: str = 'grpc', request_type=data_labeling_service.DeleteEvaluationJobRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_evaluation_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_evaluation_job_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.DeleteEvaluationJobRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_evaluation_jobs(transport: str = 'grpc', request_type=data_labeling_service.ListEvaluationJobsRequest):
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_evaluation_jobs_async(transport: str = 'grpc_asyncio', request_type=data_labeling_service.ListEvaluationJobsRequest):
    client = DataLabelingServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListEvaluationJobsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_evaluation_jobs_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, evaluation_job.EvaluationJob)
                   for i in results)
...
def test_data_labeling_service_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.datalabeling_v1beta1.services.data_labeling_service.transports.DataLabelingServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@requires_google_auth_lt_1_25_0
def test_data_labeling_service_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        DataLabelingServiceClient()
...
@requires_google_auth_lt_1_25_0
def test_data_labeling_service_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_data_labeling_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_data_labeling_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
def test_data_labeling_service_host_no_port():
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='datalabeling.googleapis.com'),
    )
    assert client.transport._host == 'datalabeling.googleapis.com:443'
...
def test_data_labeling_service_host_with_port():
    client = DataLabelingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='datalabeling.googleapis.com:8000'),
    )
